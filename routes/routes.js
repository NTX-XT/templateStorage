...
module.exports = (app) => {
  ...
  app.get("/api/templates/:capability/:department/:page/:sort", TemplatesController.getFiltered);
  ...
  app.get("/totalCount/:capability/:department/:page", TemplatesController.totalCount);
